    ...
    <div>
      <div className="lg:flex">
        <div className="lg:ml-[6rem] ml-[1rem]">
          <p className="lg:text-[2rem] lg:block hidden leading-tight font-semibold lg:mt-[3rem] mt-[1rem]">
            The client <br />
          ...
          <p className="mt-4 text-[#abacac] text-lg">
        ...
        <div className="mr-[2rem] my-[1rem]">
          <img src="/1_Hero_Active-2.png" alt="Hero" />
        </div>
      </div>
